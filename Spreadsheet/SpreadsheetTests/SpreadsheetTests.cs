...
namespace DevelopmentTests
{
    ...
    {
        [TestMethod]
        public void SetCellContentsStringSimpleTest()
        {
            AbstractSpreadsheet s = new Spreadsheet();
            List<string> l = new List<string>(s.SetContentsOfCell("A1", "Hello"));
            Assert.AreEqual("A1", l[0]);
            Assert.AreEqual(1, l.Count);
        }

        [TestMethod]
        public void SetCellContentsDoubleSimpleTest()
        {
            Spreadsheet s = new Spreadsheet();
            List<string> l = new List<string>(s.SetContentsOfCell("A1", "3.0"));
            Assert.AreEqual("A1", l[0]);
            Assert.AreEqual(1, l.Count);
        }

        [TestMethod]
        public void SetCellContentsFormulaSimpleTest()
        {
            Spreadsheet s = new Spreadsheet();
            Formula f = new Formula("3 + 3");
            List<string> l = new List<string>(s.SetContentsOfCell("A1", "=3 + 3"));
            Assert.AreEqual("A1", l[0]);
            Assert.AreEqual(1, l.Count);
        }

        [TestMethod]
        public void SetCellContentsFormulaWithDependentsTest()
        {
            Spreadsheet s = new Spreadsheet();
            s.SetContentsOfCell("A1", "3.0");
            s.SetContentsOfCell("B1", "=A1 + 3");
            s.SetContentsOfCell("C1", "=B1 + 3");
            List<string> l = new List<string>(s.SetContentsOfCell("A1", "4.0"));
            Assert.AreEqual("A1", l[0]);
        ...
        public void GetNamesOfNonEmptyCellsTest()
        {
            ...
            List<string> l = new List<string>(s.GetNamesOfAllNonemptyCells());
            Assert.AreEqual("A1", l[0]);
            Assert.AreEqual("B1", l[1]);
            Assert.AreEqual("C1", l[2]);
        }
        ...
        [TestMethod]
        public void GetCellContentsAllTest()
        {
            Spreadsheet s = new Spreadsheet();
            Formula f = new Formula("3 + 3");
            s.SetContentsOfCell("A1", "=3 + 3");
        ...
        public void SetCellContentsFormulaCircularDepedencyTest()
        {
            Spreadsheet s = new Spreadsheet();
            s.SetContentsOfCell("A1", "3.0");
            s.SetContentsOfCell("B1", "=A1 + 3");
            ...
            {
                Assert.AreEqual(new Formula("A1 + 3"), s.GetCellContents("B1"));
                throw e;
            }
        }
        ...
        public void SetCellContentsInvalidVariableTest()
        {
            Spreadsheet s = new Spreadsheet();
            string n = "Hello";
            s.SetContentsOfCell("$1", n);
        }

        [TestMethod]
        [ExpectedException(typeof(InvalidNameException))]
        public void SetCellContentsNullVariableTest()
        {
            Spreadsheet s = new Spreadsheet();
            string n = "Hello";
            string n2 = null;
            s.SetContentsOfCell(n2, n);
        }

        [TestMethod]
        [ExpectedException(typeof(InvalidNameException))]
        public void GetCellContentsNullVariableTest()
        {
            Spreadsheet s = new Spreadsheet();
            s.SetContentsOfCell("A1", "3.0");
        ...
        [TestMethod]
        public void GetCellValueAllTest()
        {
            Spreadsheet s = new Spreadsheet();
            s.SetContentsOfCell("A1", "=8 + 8");
            s.SetContentsOfCell("B1", "8.2");
            s.SetContentsOfCell("C1", "Hello");
            s.SetContentsOfCell("D1", "=9 / 0");
            Assert.AreEqual(16.0, s.GetCellValue("A1"));
            Assert.AreEqual(8.2, s.GetCellValue("B1"));
            Assert.AreEqual("Hello", s.GetCellValue("C1"));
            Assert.IsInstanceOfType(s.GetCellValue("D1"), typeof(FormulaError));
            Assert.AreEqual("", s.GetCellValue("E1"));
        }

        [TestMethod]
        public void CreatingASpreadsheetFromXMLFileUisng3rdConstructor()
        {
            ...
            using (XmlWriter writer = XmlWriter.Create("Test.txt", settings))
            {
                ...
                for (int i = 0; i < 4; i++)
                {
                    ...
                    writer.WriteElementString("name", "A" + (i+1));
                    writer.WriteElementString("contents", "" + (i + 1));
            ...
            AbstractSpreadsheet s = new Spreadsheet("Test.txt", x => true, x => x, "default");
            List<string> l = new List<string>(s.GetNamesOfAllNonemptyCells());
            Assert.AreEqual("A1", l[0]);
            Assert.AreEqual("A2", l[1]);
            Assert.AreEqual("A3", l[2]);
            Assert.AreEqual("A4", l[3]);
        }

        [TestMethod]
        public void SavingASpreadsheetToAnXMLFile()
        {
            ...
            AbstractSpreadsheet s2 = new Spreadsheet("Save.txt", x => true, x => x, "default");
            Assert.AreEqual(3.0, s2.GetCellContents("A1"));
            Assert.AreEqual(new Formula("A1 + 3"), s2.GetCellContents("B1"));
            Assert.AreEqual(new Formula("B1 + 3"), s2.GetCellContents("C1"));
        }

        [TestMethod]
        [ExpectedException(typeof(SpreadsheetReadWriteException))]
        public void SavingASpreadsheetToAInvalidFilePath()
        {
            ...
            s.SetContentsOfCell("B1", "=A1 + 3");
            s.SetContentsOfCell("C1", "=B1 + 3");
            s.Save("C:\\random\\filepath\\Save.txt");
        }

        [TestMethod]
        public void CreatingABigSpreadsheetAndChangingTheContentsToHitEdgeCases()
        {
            ...
            s.SetContentsOfCell("B1", "=A1 + 3");
            s.SetContentsOfCell("C1", "=B1 + 3");
            s.SetContentsOfCell("D1", "=C1 + 3");
            s.SetContentsOfCell("A2", "5.0");
            s.SetContentsOfCell("B2", "=A2 + 3");
            s.SetContentsOfCell("C2", "=B2 + 3");
            s.SetContentsOfCell("D2", "=C2 + 3");

            Assert.AreEqual(1, s.SetContentsOfCell("D1", "5.0").Count);
            Assert.AreEqual(1, s.SetContentsOfCell("C1", "=D1 + 5").Count);
            Assert.AreEqual(1,s.SetContentsOfCell("D2", "Hello").Count);
            Assert.AreEqual(3, s.SetContentsOfCell("A2", "7.0").Count);
            Assert.AreEqual(2, s.SetContentsOfCell("A1", "10.0").Count);
        }

        [TestMethod]
        public void AddingAnEmptyCellDoesntModifyTheSpreadsheet()
        {
            Spreadsheet s = new Spreadsheet();
        ...
        [TestMethod]
        [ExpectedException(typeof(SpreadsheetReadWriteException))]
        public void CreatingASpreadsheetFromXMLFileUisng3rdConstructorButVersionsAreNotTheSame()
        {
            XmlWriterSettings settings = new XmlWriterSettings();
            settings.Indent = true;
            settings.IndentChars = "   ";

            using (XmlWriter writer = XmlWriter.Create("Test2.txt", settings))
            {
                writer.WriteStartDocument();
                writer.WriteStartElement("spreadsheet");
            ...
            AbstractSpreadsheet s = new Spreadsheet("Test2.txt", x => true, x => x, "default");
        }

        [TestMethod]
        [ExpectedException(typeof(SpreadsheetReadWriteException))]
        public void CreatingASpreadsheetFromNonExistingXMLFileUisng3rdConstructor()
        {
            AbstractSpreadsheet s = new Spreadsheet("Test3.txt", x => true, x => x, "default");
        }

        [TestMethod]
        [ExpectedException(typeof(CircularException))]
        public void SetCellContentsFormulaCircularDepedencyTestOnItself()
        {
            Spreadsheet s = new Spreadsheet();
            try
            {
        ...
        [TestMethod]
        [ExpectedException(typeof(SpreadsheetReadWriteException))]
        public void GetSavedVersionThrowsForNoVersionVersion()
        {
            XmlWriterSettings settings = new XmlWriterSettings();
            settings.Indent = true;
            settings.IndentChars = "   ";

            using (XmlWriter writer = XmlWriter.Create("Test4.txt", settings))
            {
                writer.WriteStartDocument();
                writer.WriteStartElement("spreadsheet");
                for (int i = 0; i < 4; i++)
            ...
            AbstractSpreadsheet s = new Spreadsheet("Test4.txt", x => true, x => x, "");
        }

        [TestMethod]
        [ExpectedException(typeof(SpreadsheetReadWriteException))]
        public void ThirdConstructorThrowsForInvalidCells()
        {
            XmlWriterSettings settings = new XmlWriterSettings();
            settings.Indent = true;
            settings.IndentChars = "   ";

            using (XmlWriter writer = XmlWriter.Create("Test5.txt", settings))
            {
                writer.WriteStartDocument();
                writer.WriteStartElement("spreadsheet");
                writer.WriteAttributeString("version", "default");
            ...
            AbstractSpreadsheet s = new Spreadsheet("Test5.txt", x => true, x => x, "default");
        }

        [TestMethod]
        [ExpectedException(typeof(InvalidNameException))]
        public void GetCellValueNullVariableTest()
        {
            Spreadsheet s = new Spreadsheet();
            s.SetContentsOfCell("A1", "3.0");
            s.GetCellValue(null);
